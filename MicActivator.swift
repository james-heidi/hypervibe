...
final class MicActivator {
    ...
    func arm() {
        ...
        for device in set {
            ...
            // Apple vendor; A2854 product 0x0315 (789), A2540 product 0x0314 (788).
            // Also accept other Siri remotes.
            let isApple = vendor == 0x004C || vendor == 1452
            let isRemote = product == 0x0315 || product == 0x0266 || product == 0x0314
                || product == 789 || product == 614
